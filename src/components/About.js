    ...
    <>
      <div className="bg-glintGreen">
        <div className="w-[90%] mx-auto lg:flex lg:flex-wrap lg:justify-start lg:w-[80%] xl:w-[70%]">
          <div className="lg:w-[45%] lg:pt-5 xl:mt-20 animation-about-one" data-aos="fade-up">
            <img
          ...
          <div className="sm:w-[70%] mx-auto md:w-[90%] lg:w-[45%] xl:mt-10 animation-about-one" data-aos="fade-up">
          ...
          <div className="flex flex-col w-[60%] mx-auto my-10 sm:w-[70%] sm:flex-row sm:flex-wrap sm:justify-between md:w-[90%] lg:w-[45%] xl:mt-10 lg:mr-20" data-aos="fade-up">
          ...
          <div className="bg-gray-700 py-2 lg:mb-14 sm:w-[70%] mx-auto md:w-[60%] lg:w-[45%] lg:mt-10 xl:mt-10" data-aos="fade-up">
            <div className="w-[80%] mx-auto flex justify-start items-center my-10">
              <span className="text-8xl font-bold text-black 2xl:text-9xl">10</span>
