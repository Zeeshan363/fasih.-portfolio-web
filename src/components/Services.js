...
const Services = () => {
  ...
  return (
    <>
      <div className="w-[70%] mx-auto sm:w-[80%]">
        <div className="text-center my-10" data-aos="fade-up">
          <h1 className="text-lg font-bold text-glintGreen md:text-xl xl:text-2xl">WHAT WE DO</h1>
        ...
        <div className="md:flex md:flex-wrap">
          <div className="flex flex-col items-center my-10 md:w-[45%] mx-auto lg:flex-none xl:w-[40%]" data-aos="fade-up">
            <div>
              <AiOutlineFormatPainter className="h-16 w-16 md:h-20 md:w-20 text-glintGreen" />
            </div>
            <div className="text-center">
              <h1 className="text-xl font-bold py-5 sm:text-2xl xl:text-3xl 2xl:py-10">Brand Identity</h1>
